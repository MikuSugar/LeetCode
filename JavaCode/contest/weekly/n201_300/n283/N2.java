...
public class N2 {
    public static void main(String[] args) {
        System.out.println(new N2().minimalKSum(
                Parse.parseToIntArray("[21,63,1,98,10,77,58,10,21,99,40,27,5,67,90,29,56,16,34,25,26,17,8,3,4,17,14,32,12,17,37,81,18,49,59,23,63,39,64,7,18,35,89,11,42,30,6,15,81,52,24,39,48,9,19,34,24,2,28,13,53,4,22,20,42,2,5,58,36,31,60,38,33]"
                ), 20
        ));
    }
