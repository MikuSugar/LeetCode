...
public class N2467_most_profitable_path_in_a_tree {
    ...
    public static void main(String[] args) {
        System.out.println(new N2467_most_profitable_path_in_a_tree().mostProfitablePath(
                Parse.parseToIntTwoArray("[[0,1],[1,2],[1,3],[3,4]]"),
                3,
                Parse.parseToIntArray("[-2,4,2,-4,6]")));
        System.out.println(new N2467_most_profitable_path_in_a_tree().mostProfitablePath(
                Parse.parseToIntTwoArray("[[0,1]]"),
                1,
                Parse.parseToIntArray("[-7280,2350]")));
        ...
        //预期 17034
        System.out.println(new N2467_most_profitable_path_in_a_tree().mostProfitablePath(
                Parse.parseToIntTwoArray("[[0,21],[0,6],[0,29],[1,3],[1,38],[2,31]," +
                ...
                26,
                Parse.parseToIntArray("[3756,7618,130,-1544,-3646,4384,-9736,2100,-7186,-3798," +
