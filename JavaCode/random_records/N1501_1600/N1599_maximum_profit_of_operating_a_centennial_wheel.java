 ...
 * date: 2020/10/2 4:54 下午
 */
public class N1599_maximum_profit_of_operating_a_centennial_wheel {
    ...
    public int minOperationsMaxProfit(int[] customers, int boardingCost, int runningCost) {
        int wait=0,profit=0,res=-1,idx=0;
        int preMAX=0;
        while (idx<customers.length||wait>0)
        {
            if(idx<customers.length)wait+=customers[idx];
            idx++;
            if(wait>=4)
            {
                wait-=4;
